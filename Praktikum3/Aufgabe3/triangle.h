...
public:
    ...
    Triangle() : p1_x(0), p1_y(0), p2_x(0), p2_y(0), p3_x(0), p3_y(0), a(Line()), b(Line()), c(Line()) {
    };

    //weiterer Konstruktor

    Triangle(int p1x, int p1y, int p2x, int p2y, int p3x, int p3y) : p1_x(p1x), p1_y(p1y), p2_x(p2x), p2_y(p2y), p3_x(p3x), p3_y(p3y), a(Line()), b(Line()), c(Line()) {
    ...
    Triangle(int hor, int ver, int line1, int line2, int line3) : p1_x(hor), p1_y(ver), p2_x(hor + get_hypotenuse(line1, line2, line3)), p2_y(ver), p3_x(hor + get_x(line1, line2, line3)), p3_y(ver + get_height(line1, line2, line3)), a(Line()), b(Line()), c(Line()) {
        b.set(p1_x, p1_y, p3_x, p3_y);
        c.set(p2_x, p2_y, p3_x, p3_y);
        a.set(p2_x, p2_y, p1_x, p1_y);
        ;
...
bool proof_Triangle(int p1x, int p1y, int p2x, int p2y, int p3x, int p3y) {
    ...
    if (a == 0) { //wenn p1 und p2 gleiche x koordinaten
        if (b == 0) {
            return false;
        } else {
            return true;
    ...
    if (b == 0) { //wenn p1 und p3 gleiche x koordinaten
        if (a == 0) {
            return false;
        } else {
            return true;
